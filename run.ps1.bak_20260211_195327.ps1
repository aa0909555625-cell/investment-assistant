...
# Scenario filter for console/report sections
...
$dashboard = [pscustomobject]@{
  ...
  inputs = @{ user_cash=$Cash; heat_weight=$heatWeight; scenario=$Scenario }
...
$dashboard | ConvertTo-Json -Depth 10 | Set-Content -Path $pmJson -Encoding UTF8

# TXT: watch-style layout (Top/Bottom non-overlap)
$twse = FindIndex "TWSE"
$otc  = FindIndex "OTC"
...
# Write TXT as UTF8 No BOM (emoji safe for parsers)
